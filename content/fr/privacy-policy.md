...
description: "Politique de confidentialité de Magalie Seabrooke"
layout: privacy
...
Magalie Seabrooke ("nous", "nous" ou "notre") exploite le site Web https://www.magalieseabrooke.ca (ci-après dénommé le "service").
...
-   Service\
    Le service est le site Web https://www.magalieseabrooke.ca exploité par Magalie Seabrooke.
...
Nous pouvons utiliser vos données personnelles pour vous contacter avec des lettres d'information, du matériel de marketing ou promotionnel et d'autres informations susceptibles de vous intéresser. Vous pouvez refuser de recevoir tout ou partie de ces communications en nous contactant.
...
Magalie Seabrooke.ca utilise les données collectées à différentes fins:
...
Magalie Seabrooke peut divulguer vos données personnelles en croyant de bonne foi qu'une telle action est nécessaire pour:

-   Se conformer à une obligation légale
-   Pour protéger et défendre les droits ou la propriété de MagalieSeabrooke.ca
...
MagalieSeabrooke.ca utilise des services de remarketing pour faire de la publicité sur des sites Web tiers après votre visite de notre service. Nous et nos fournisseurs tiers utilisons des cookies pour informer, optimiser et diffuser des annonces en fonction de vos visites précédentes à notre Service.
...
-   Par email: info@magalieseabrooke.ca